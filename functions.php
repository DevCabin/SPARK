<?php
/**
 * Growth Spark functions and definitions
 *
...
function growthspark_setup() {
	 ...
	 * If you're building a theme based on Growth Spark, use a find and replace
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'growthspark' ),
		// 'primary' => esc_html__( 'Primary', 'growthspark' ),
	) );
...
function growthspark_scripts() {
	...
	wp_enqueue_script( 'growthspark-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'growthspark-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function wpdocs_hack_wp_title_for_home( $title )
{
  if ( empty( $title ) && ( is_home() || is_front_page() ) ) {
    $title = __( get_bloginfo( 'name' ), 'growthspark' ) . ' - ' . get_bloginfo( 'description' );
  }
  return $title;
}
